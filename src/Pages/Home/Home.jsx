                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
                        <ul className="navbar-nav ">
                            <li className="nav-item">
                                <div onClick={openModal} className="profile text-center justify-items-center"><b className="p-txt">AM</b></div>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="container">
                    ...
                    <div className="row mt-3">
                        <div className="col-md-12 text-center">
                            <p className="extraTxt2">AutoMedics Africa Limited</p>
                            <smalls>2 agents license</smalls>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-12">
                            <button className="botin2">Manage your Recallo Account</button>
                        </div>
                    </div>
                    <div className="row mt-1">
                        <div className="col-md-12 text-center">
                            <hr />
                            <smalls>Log out</smalls>
                        </div>
                    </div>
                </div>
            </div>
